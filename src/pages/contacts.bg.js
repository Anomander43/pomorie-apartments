    ...
    return (
      <ContactsStyle>
        ...
        <ContactInfo>
          ...
          <p>
          Изпратете съобщение за периода, през който искате да отседнете при нас, и ние ще Ви отговорим за съществуващите възможности. След потвърждение от наша страна по имейл или телефон, в уговорения срок трябва да заплатите сумата от три нощувки - по банков път, Western Union или Money Gram.
          </p>
          <address>
          Лице за контакт: Мария Янева
          <br/>
          Телефон: +359 889 555 063
          <br/>
          Телефон: +359 899 79 78 79
          <br/>
          E-mail: <a href="mailto:mariyag43@abv.bg">mariyag43@abv.bg</a>
          </address>
        </ContactInfo>
        <ContactFormHolder>
          <h2>Форма за връзка</h2>
          <Form />
        </ContactFormHolder>
      </ContactsStyle>
    )
